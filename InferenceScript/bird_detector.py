...
#Early endpoint - POC only. Delete this
#endpoint_name = 'birdsong-pre-mel-epoch10-minibatch8-ep--2022-03-16-03-41-52'
#Endpoint that uses model leveraging transfer learning:
#endpoint_name = 'birdsong-tl-mel-e10-mb8-sz224-ep--2022-03-17-08-22-43'
#Endpoint that uses model trained from scratch - no transfer learning:
endpoint_name = 'birdsong-no-tl-mel-e10-mb8-sz224-ep--2022-03-17-08-22-43'
...
def process_audio(audio_file):
    ...
    for i in range(0, (int(length)-3)*1000, 500):
        ...
        if (confidence < 0.8):
           prediction = "unknown"
        print(start, prediction, confidence)
...
# To Do: remove dependency on Path and use os.path instead
